...
import { WalletAccountV5, walletV5, validateAndParseAddress, constants as SNconstants, json } from "starknetV9";
import { WALLET_API } from "@starknet-io/types-js";
import { myFrontendProvidersV9 } from "@/utils/constants";
...
export default function SelectWallet() {
  ...
  async function handleSelectedWallet(selectedWallet: WalletWithStarknetFeatures) {
    ...
    const myWA: WalletAccountV5 = await WalletAccountV5.connect(myFrontendProvidersV9[2], selectedWallet);
              ...
              >
                {
                  wallets.map((wallet: WalletWithStarknetFeatures, index: number) => {
                    ...
                    return <>
                      {isStarknetWallet(wallet) && wallet.name=="Ready Wallet" ? <>
                        <Button
